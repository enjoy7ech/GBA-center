...
export const games: Game[] = [
  ...
  {
    id: 'castlevania-aria-of-sorrow-jiuliu-chs-jp',
    title: '恶魔城：晓月圆舞曲',
    subtitle: 'CASTLEVANIA: ARIA OF SORROW',
    rom: '/roms/castlevania-aria-of-sorrow-jiuliu-chs-jp.gba',
    // 日版封面扫描：https://castlevaniadungeon.net/games/aria.html
    cover: '/covers/castlevania-aria-of-sorrow-jp.jpg',
    color: '#52659a',
    year: '2003',
    tags: ['动作 RPG', '九柳汉化', '日版'],
    // A2CJ 日版地址；已核对九柳汉化 ROM 的游戏代码。
    // 来源：https://wikiwiki.jp/gb_code/キャッスルヴァニア　～暁月の円舞曲～
    cheats: [
      {
        id: 'castlevania-aos-jp-hp-999',
        name: 'HP 999',
        code: '0201326E:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-aos-jp-max-money',
        name: '金钱 999999（生效后关闭）',
        code: '02013284:000F423F',
        enabled: false,
        builtIn: true,
      },
      {
        id: 'castlevania-aos-jp-defense-999',
        name: '体质 CON 999',
        code: '02013278:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-aos-jp-intelligence-999',
        name: '智力 INT 999',
        code: '0201327A:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-aos-jp-luck-999',
        name: '幸运 LCK 999',
        code: '0201327C:03E7',
        enabled: false,
        builtIn: true,
  ...
  {
    id: 'castlevania-harmony-of-dissonance-chs-jp',
    title: '恶魔城：白夜协奏曲',
    subtitle: 'CASTLEVANIA: HARMONY OF DISSONANCE',
    rom: '/roms/castlevania-harmony-of-dissonance-chs-jp.gba',
    // 日版封面：https://www.vgmuseum.com/mrp/NewCV/box-jhod.htm
    cover: '/covers/castlevania-harmony-of-dissonance-jp.jpg',
    color: '#874663',
    year: '2002',
    tags: ['动作 RPG', '施珂昱汉化', '日版'],
    // ACHJ 日版地址；汉化 ROM 保留日版游戏代码。勿替换为美版地址。
    // 参考：https://www.games.idv.tw/finger.php?id=219&mode=view
    // 汉化 ROM + mGBA 实测：STR/DEF/LCK 写当前属性；魔法书使用 8 位 CodeBreaker，仅置五本书的标志。
    cheats: [
      {
        id: 'castlevania-hod-jp-hp-999',
        name: 'HP 999',
        code: '02018542:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-hod-jp-hearts-999',
        name: '爱心 999',
        code: '02018788:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-hod-jp-max-money',
        name: '金钱 99999999（生效后关闭）',
        code: '02018790:05F5E0FF',
        enabled: false,
        builtIn: true,
      },
      {
        id: 'castlevania-hod-jp-strength-999',
        name: '力量 999',
        code: '02018546:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-hod-jp-defense-999',
        name: '防御 999',
        code: '02018548:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-hod-jp-luck-999',
        name: '幸运 999',
        code: '0201854C:03E7',
        enabled: false,
        builtIn: true,
      ...
      {
        id: 'castlevania-hod-jp-all-spellbooks',
        name: '全部魔法书（生效后关闭）',
        code: '32018832 001F',
        enabled: false,
        builtIn: true,
